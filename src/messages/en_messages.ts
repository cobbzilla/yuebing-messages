export default {
  ...
  label_destination_name: 'Storage Volume Name',
  label_self_volume: '{{ title }} storage',
  label_volume_type: 'Data Volume Type',
  label_volume_system: 'System Volume',
  label_volume_system_hint: 'Makes this a bootable volume: keep system files in sync with this system',
  ...
  label_volume_cacheSize: 'Listing cache size (zero to disable)',
  label_volume_encryptionEnable: 'Enable encryption?',
  label_volume_encryptionKey: 'Encryption key',
  label_volume_encryptionIV: 'Initialization vector (IV)',
  label_volume_encryptionAlgo: 'Algorithm',
  ...
  label_volumeType_local_field_createIfNotExist: 'Create mount directory (if it does not exist)?',
  ...
  label_volumeType_generic_field_driver: 'Driver name',
  label_volumeType_generic_field_key: 'Driver key',
  label_volumeType_generic_field_secret: 'Driver secret',
  label_volumeType_generic_field_opts: 'Driver options (JSON object)',
